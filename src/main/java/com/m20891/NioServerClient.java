...
public class NioServerClient {
    ...
    private ByteBuffer flag = ByteBuffer.wrap(new byte[]{11});
    ...
    public SocketChannel connectType(SocketChannel channel) throws IOException, ExecutionException, InterruptedException, TimeoutException {
        ...
        clientChannel.write(ByteBuffer.wrap(github.getBytes(StandardCharsets.UTF_8)));
        clientChannel.write(ByteBuffer.wrap(host.get("url").getBytes(StandardCharsets.UTF_8)));
    ...
    public static void main(String[] args) {
        NioServerClient nioServer = new NioServerClient();
