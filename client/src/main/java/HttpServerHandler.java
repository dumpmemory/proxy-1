...
//                    .set(CONTENT_TYPE, TEXT_PLAIN)
                    ...
                    .set("Server","ShadowsocksWindows/4.1.9.2")
//                    .set(ACCESS_CONTROL_EXPOSE_HEADERS, FILENAME)
//                    .set(CONTENT_DISPOSITION, "attachment;filename=" + URLEncoder.encode("pac", "UTF-8"))
